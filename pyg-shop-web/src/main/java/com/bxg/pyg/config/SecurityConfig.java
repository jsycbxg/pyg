package com.bxg.pyg.config;

import com.bxg.pyg.controller.SellDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    public SellDetailsServiceImpl userDetailsServiceImpl() {
        return new SellDetailsServiceImpl();
    }
