...
import com.bxg.pyg.pojo.TbSpecificationOptionExample.Criteria;
import com.bxg.pyg.sellgoods.service.SpecificationOptionService;
...
public class SpecificationOptionServiceImpl implements SpecificationOptionService {
	...
	@Override
	public List<TbSpecificationOption> findList(int specid) {
		TbSpecificationOptionExample example=new TbSpecificationOptionExample();
		Criteria criteria=example.createCriteria();
		criteria.andSpecIdEqualTo((long)specid);
